...
// Operatorius -- atimmamas 1 is nurodyto kintamojo
if (kint1 === 0) count0++;
...
console.log(`Skaiciu 0 - ${count0}\t 1 - ${count1}\t 2 - ${count2}`);
...
if  (skaic1 === 0 || skaic2 === 0) console.log(`Dalyba is nulio negalima!`);
else
{
    if (skaic1 > skaic2) console.log((skaic1 / skaic2).toFixed(2));
    else console.log((skaic1 / skaic2).toFixed(2));
}
...
console.log(String.fromCharCode(rand(97,122)), String.fromCharCode(rand(97,122)), String.fromCharCode(rand(97,122)));
